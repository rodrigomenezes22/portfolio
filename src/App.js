...
function App() {
  ...
  const temperatureCelsius =
    weatherData && weatherData.main
      ? Math.ceil((weatherData.main.temp - 273.15).toFixed(2))
      : null;
  ...
  const [workPortfolio, setWorkPortfolio] = useState([
    {
      name: "MyHomeServices",
      description:
        "Final Project built with PERN Stack - The Server is on a Free Deployment, so it can take 30 seconds or more to start.",
